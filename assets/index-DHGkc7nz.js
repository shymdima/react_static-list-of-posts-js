...
aut aut aut maxime quia temporibus ut omnis`}],Rc=({posts:e})=>R.jsx("div",{className:"PostList",children:e.map(t=>{const i={...t};return i.user=Tc.find(n=>n.id===t.userId),i.comments=Mc.filter(n=>n.postId===t.id),R.jsx(Lc,{post:i},i.id)})}),Ur=[{id:1,userId:1,title:"sunt aut facere repellat provident occaecati excepturi optio reprehenderit",body:`quia et suscipit
...
expedita consequatur consequatur dolores quia eos et placeat`}],Dc=()=>R.jsxs("section",{className:"App",children:[R.jsx("h1",{className:"App__title",children:"Static list of posts"}),R.jsx(Rc,{posts:Ur},Ur.id)]});tm(document.getElementById("root")).render(R.jsx(Dc,{}));
